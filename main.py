    ...
    if check_rate_limit(id):
        ...
        if internet == "on":
            ...
            if ddg_response.ok:
                ...
                return flask.jsonify({"error": "Web scraping failed. Please try again later."}), 200
        ...
        # Pass list of messages to g4f.ChatCompletion.create method with model as 'gpt-4' and provider as g4f.Provider.GetGpt, have no choice but have to use g4f.Provider.ChatgptAi
